...
export const dilemas: Dilema[] = [
  {
    ...
    contexto_oculto:
      "A creche do Oziel vai fechar por falta de verba. A câmara votou ontem. Nenhum morador do bairro foi à audiência pública marcada há três semanas. O vereador que poderia ter salvado a verba perdeu por dois votos.",
    pilula_sabedoria:
  ...
  },
  {
    ...
    contexto_oculto:
      "A creche do Oziel fechou por dois votos. O encontro de hoje mostrou que presença física em audiência pública tem peso de lei — e que 200 assinaturas não substituem três pessoas na sala.",
    pilula_sabedoria:
