...
const DESCRIPTION =
  "Memes, dilemas e as consequências que eles escondem. Um jogo de 3 minutos sobre participação popular, feito por e para a juventude do Oziel, Campinas."
...
export const metadata: Metadata = {
  ...
  keywords: ["Oziel", "Campinas", "cidadania", "participação popular", "desinformação", "serious game", "juventude"],
  openGraph: {
    type: "website",
    locale: "pt_BR",
    url: SITE_URL,
